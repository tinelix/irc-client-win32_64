...
CLEAN : 
	...
	-@erase ".\Release\MentionWindow.obj"
...
"$(INTDIR)\MentionWindow.obj" : $(SOURCE) $(DEP_CPP_MENTI) "$(INTDIR)"\
 "$(INTDIR)\TinelixIRC.pch"
